 ...
 * @property {function(import('../module/global-references.js').Attribute): number} breakpoint
...
export default class HitFatPoints {
  ...
  /**
   * @param {string} type
   * @param {import('../module/global-references.js').Attribute} value
   * @param {string} attr
   */
  ...
  /**
   * @param {import('../module/global-references.js').Attribute} HP
   * @param {string} member
   */
  ...
  /**
   * @param {import('../module/global-references.js').Attribute} FP
   * @param {string} member
   */
  ...
  /**
   * @param {import('../module/global-references.js').Attribute} pts
