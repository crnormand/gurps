...
export default class HitFatPoints {
  ...
  setup() {
    ...
    Handlebars.registerHelper('hpFpCondition', (type, value, attr) => {
    ...
    Handlebars.registerHelper('hpFpBreakpoints', (type, value, opt) => {
    ...
    Handlebars.registerHelper('hpCondition', this.hpCondition)
    Handlebars.registerHelper('hpBreakpoints', this.getHpBreakpoints)

    Handlebars.registerHelper('fpCondition', this.fpCondition)
    Handlebars.registerHelper('fpBreakpoints', this.getFpBreakpoints)
  }

  _getConditionKey(pts, conditions) {
    let found = conditions['NORMAL']
    for (const [key, value] of Object.entries(conditions)) {
      if (pts.value > value.breakpoint(pts)) {
        return found
      }
      found = key
    }
