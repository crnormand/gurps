...
export class DamageCalculator {
    ...
    get effectiveWoundModifiers() {
        ...
        if (this._useLocationModifiers) {
            switch (this._hitLocation) {
                ...
                default:
                    if ([...extremities, ...limbs].includes(this._hitLocation))
    ...
    get isInjuryTolerance() { return this._isInjuryTolerance && this._injuryToleranceType !== null }
    ...
    get isWoundModifierAdjustedForLocation() {
        if (this._useLocationModifiers) {
            return ['Vitals', 'Skull', 'Eye', 'Face', 'Neck', ...extremities, ...limbs]
                .includes(this._hitLocation)
        }
        return false
    }
}