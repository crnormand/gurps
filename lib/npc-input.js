...
import { GurpsActor, Advantage, Skill, Melee, Ranged, HitLocation, Encumbrance, Note, Equipment } from "../module/actor.js";
  ...
  checkTraits() {
    ...
    this.prep(m.equipment).forEach(e => { 
      txt += "\n" + e;
			...
			let a = e.split(";");
			if (a.length != 4)
				this.addToNotes(arr, "Expecting name;qty;$cost;weight lbs\n");
			else {
