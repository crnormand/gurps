...
export function initializeSettings() {
  Hooks.once('init', async function () {
    ...
    game.settings.register(SYSTEM_NAME, SETTING_SHOW_3D6, {
      name: 'UI: Show 3D6 (next to Modifier Bucket)',
      hint: 'If checked, the system will display the three red 6 sided dice to the right of the Modifier Bucket.  You must reload for this change to take effect.',
      scope: 'client',
      config: true,
      type: Boolean,
      default: true,
    ...
    game.settings.register(SYSTEM_NAME, SETTING_IMPORT_HP_FP, {
      name: i18n('GURPS.settingImportHPAndFP', 'Import: Current HP and FP'),
    ...
    game.settings.register(SYSTEM_NAME, SETTING_USE_CONDITIONAL_INJURY, {
      name: 'Damage: Conditional Injury',
