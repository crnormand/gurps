...
////////////////////////////////////////
import ColorCharacterSheetSettings from '../module/color-character-sheet/color-character-sheet-html.js'
import { parseCss, findSelectorRule } from '../lib/parse-css-file/parse-css-file.js'
...
let defaultColorBackground = ''
let defaultColorText = ''
let hoverColorBackground = ''
let hoverTextColor = ''
...
$.ajax({
  ...
  let parsedCSS = parseCss(css)
  defaultColorBackground = findSelectorRule(parsedCSS, '.rollable', 'background-color')
  defaultColorText = findSelectorRule(parsedCSS, '.rollable', 'color')
  hoverColorBackground = findSelectorRule(parsedCSS, '.rollable:hover', 'background-color')
  hoverTextColor = findSelectorRule(parsedCSS, '.rollable:hover', 'color')
  console.log(defaultColorBackground + ' ' + defaultColorText + ' ' + hoverColorBackground + ' ' + hoverTextColor)
}).fail(function(xhr) {
  console.log(xhr)
  // Todo something...
})
...
export const SETTING_DEFAULT_COLOR_BACKGROUND = defaultColorBackground // Was '#ffffbe'
export const SETTING_DEFAULT_COLOR_TEXT = defaultColorText // Was '#000000'
export const SETTING_DEFAULT_COLOR_BACKGROUND_HOVER = hoverColorBackground // Was '#cccc00'
export const SETTING_DEFAULT_COLOR_TEXT_HOVER = hoverTextColor // Was '#000000'
