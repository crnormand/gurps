...
import { QuickRollSettings } from '../module/token-hud.js'
...
export const SETTING_DRAG_ON_TOKEN_DAMAGE = 'drag-on-token-damage'
...
export const SETTING_AUTO_ADD_TAGGED_MODIFIERS = 'auto-add-tagged-modifiers'
export const SETTINGS_ALLOW_ROLL_BASED_ON_MANEUVER = 'allow-roll-based-on-maneuver'
...
export function initializeSettings() {
  Hooks.once('init', async function () {
    ...
    game.settings.register(SYSTEM_NAME, SETTING_DRAG_ON_TOKEN_DAMAGE, {
      name: i18n('GURPS.settingDragOnTokenDamage'),
      hint: i18n('GURPS.settingHintDragOnTokenDamage'),
      scope: 'world',
      config: true,
      type: Boolean,
      default: true,
      onChange: value => console.log(`Drag on token damage : ${value}`),
    })
    ...
    game.settings.registerMenu(SYSTEM_NAME, SETTING_USE_QUICK_ROLLS, {
      name: i18n('GURPS.settingUseQuickRolls'),
      label: i18n('GURPS.settingLabelUseQuickRolls'),
      hint: i18n('GURPS.settingHintUseQuickRolls'),
      type: QuickRollSettings,
      restricted: true,
    })

    game.settings.register(SYSTEM_NAME, SETTING_SHOW_CONFIRMATION_ROLL_DIALOG, {
      name: i18n('GURPS.settingShowConfirmationRollDialog'),
      hint: i18n('GURPS.settingHintShowConfirmationRoll'),
      scope: 'client',
      config: true,
      type: Boolean,
      default: true,
      onChange: value => console.log(`Show Confirmation Roll Dialog : ${value}`),
    })

    game.settings.register(SYSTEM_NAME, SETTINGS_ALLOW_ROLL_BASED_ON_MANEUVER, {
      name: i18n('GURPS.settingAllowRollBasedOnManeuver'),
      hint: i18n('GURPS.settingHintAllowRollBasedOnManeuver'),
      scope: 'world',
      config: true,
      type: Boolean,
      default: false,
    ...
    game.settings.register(SYSTEM_NAME, SETTING_AUTO_ADD_TAGGED_MODIFIERS, {
      name: i18n('GURPS.settingAutoAddTaggedModifiers'),
      hint: i18n('GURPS.settingHintAutoAddTaggedModifiers'),
      scope: 'world',
      config: true,
      type: Boolean,
      default: true,
      onChange: value => console.log(`Add Tagged Modifiers to Bucket automatically : ${value}`),
    })
  })
}
