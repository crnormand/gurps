  ...
  Hooks.once('init', async function () {
    ...
    game.settings.register(SYSTEM_NAME, SETTING_MANEUVER_DETAIL, {
      ...
      hint: i18n(
        ...
        `Determines what maneuver is visible to players other than the GM or Owner, if any. <br>
'Full Detail': E.g., show "All-out Attack (Determined)" and "Feint" exactly as shown. <br>
'No Feint': As 'Full Detail' except Feint shows as "Attack". <br>
'General': As 'Full, No Feint' except option is not shown -- e.g., All-out Attack (Strong) shows as "All-out Attack". <br>
