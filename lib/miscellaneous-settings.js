...
export function initializeSettings() {
  Hooks.once('init', async function () {
    ...
    game.settings.register(SYSTEM_NAME, SETTING_DEFAULT_ADD_ACTION, {
      ...
      type: String,
      choices: {
        apply: i18n('GURPS.applyInjury'),
        quiet: i18n('GURPS.applyInjuryQuietly'),
    ...
    game.settings.register(SYSTEM_NAME, SETTING_ALLOW_TARGETED_ROLLS, {
      name: i18n('GURPS.settingAllowTargetedRolls'),
      hint: i18n('GURPS.settingHintAllowTargetedRolls'),
      scope: 'world',
      config: true,
      type: String,
      choices: {
    ...
    game.settings.registerMenu(SYSTEM_NAME, SETTING_USE_TAGGED_MODIFIERS, {
      name: i18n('GURPS.settingUseTaggedModifiers'),
      label: i18n('GURPS.settingLabelUseTaggedModifiers'),
      hint: i18n('GURPS.settingHintUseTaggedModifiers'),
      type: TaggedModifierSettings,
      restricted: true,
    })

    game.settings.register(SYSTEM_NAME, SETTING_MODIFY_DICE_PLUS_ADDS, {
      name: i18n('GURPS.settingModifyDicePlusAdds'),
      hint: i18n('GURPS.settingHintModifyDicePlusAdds'),
      scope: 'world',
      config: true,
      type: Boolean,
      default: false,
