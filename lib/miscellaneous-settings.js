...
export const SETTING_WHISPER_STATUS_EFFECTS = 'whisper-status-effects'
...
export function initializeSettings() {
  Hooks.once('init', async function () {
    ...
    game.settings.register('gurps', 'feature.damageTermParser', {
      name: 'Damage Term Parser',
      hint: 'If enabled, the damage term parser will be used to parse damage terms in chat messages. If disabled, the old parser will be used.',
      scope: 'client',
      config: true,
      type: Boolean,
      default: true,
      requiresReload: true,
      onChange: value => console.log(`Feature Damage Term Parser: ${value}`),
    })
    ...
    game.settings.register(SYSTEM_NAME, SETTING_PORTRAIT_HP_TINTING, {
      name: game.i18n.localize('GURPS.settingPortraitHPTinting'),
      hint: game.i18n.localize('GURPS.settingHintPortraitHPTinting'),
      scope: 'client',
      config: true,
      type: Boolean,
      default: true,
      onChange: value => console.log(`Portrait HP Tinting: ${value}`),
    })
