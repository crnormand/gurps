...
export function initializeSettings() {
  Hooks.once('init', async function () {
    ...
    game.settings.register(SYSTEM_NAME, SETTING_AUTOMATIC_ENCUMBRANCE, {
      name: "Automatically calculate Encumbrance",
      hint: "If checked, the Encumbrance level will be set automatically based on the carried equipment (and you cannot change the Encumbrance level manually).   If this is turned off, you can change the Encumbrance level by clicking on an Encumbrance level.",
      scope: "client",
      config: true,
      type: Boolean,
      default: true,
