...
export const SETTING_COLOR_ADVANTAGES_GURPSLINK = ['color-gurpslink-rollable', 'color-gurpslink-rollable-hover', 'color-gurpslink-rollable-text']
export const SETTING_COLOR_OTF_NOTES_GURPSLINK = ['color-otf-notes-rollable', 'color-otf-notes-rollable-hover', 'color-otf-notes-rollable-text']
*/
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
export function initializeSettings() {
  Hooks.once('init', async function () {
    ...
    game.settings.registerMenu(SYSTEM_NAME, SETTING_COLOR_CHARACTER_SHEET_MENU, {
      name: 'Color Character Sheet',
      hint: 'Color Character Sheet - Menu',
      label: 'Color Character Sheet',
        ...
        'colors':[
          {
            ...
            background_color: `${SETTING_DEFAULT_COLOR_BACKGROUND}`,
            hover_color: `${SETTING_DEFAULT_COLOR_BACKGROUND_HOVER}`,
            text_color: `${SETTING_DEFAULT_COLOR_TEXT}`
          },
          {
            color_override: false,
            area: 'Dodge',
    ...
    game.settings.set(SYSTEM_NAME, SETTING_COLOR_CHARACTER_SHEET_DATA, colordata)
    
    let updateSheets = function() {
        for (const actor of game.actors.contents) 
