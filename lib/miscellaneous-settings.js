...
export function initializeSettings() {
  Hooks.once('init', async function () {
    ...
    game.settings.register(SYSTEM_NAME, SETTING_MODIFIER_TOOLTIP, {
      ...
      hint:
        'If checked, the system will bring up the Modifier Tooltip when the mouse hovers over the Modifier Bucket.   If this is turned off, you can still bring up the Tooltip by Left Clicking on the Modifier Bucket.  You must restart Foundry for this setting to take effect.',
      scope: 'client',
      config: true,
      type: Boolean,
      default: true,
