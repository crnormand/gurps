...
export function initializeSettings() {
  Hooks.once('init', async function () {
    ...
    game.settings.register(SYSTEM_NAME, SETTING_AUTO_UPDATE_STRENGTH, {
      name: game.i18n.localize('GURPS.actor.setting.autoUpdateStrength'),
      hint: game.i18n.localize('GURPS.actor.setting.autoUpdateStrengthHint'),
      scope: 'world',
      config: true,
      type: Boolean,
      default: true,
      onChange: value => console.log(`Auto update strength : ${value}`),
    })
