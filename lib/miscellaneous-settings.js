...
export function initializeSettings() {
  Hooks.once('init', async function () {
    ...
    game.settings.register(SYSTEM_NAME, SETTING_BODY_HITS, {
        ...
        hint: i18n('From High Tech 162: Body Hits caps piercing, impaling, and tight-beam burning damage dealt to the torso at 2x max hp, and also adds a 1/6 chance of hitting vitals when targeting the torso.'),
        scope: 'world',
        config: true,
        type: Boolean,
        default: false,
        onChange: value => GURPS.damagecalculator.constructor(),
    })
