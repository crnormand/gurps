...
export function initializeSettings() {
  Hooks.once('init', async function () {
    ...
    game.settings.register(SYSTEM_NAME, SETTING_MODIFIER_TOOLTIP, {
      name: "Show Modifier Tooltip on mouse 'hover'",
      hint: "If checked, the system will bring up the Modifier Tooltip when the mouse hovers over the Modifier Bucket.   If this is turned off, you can bring up the Tooltip by Left Clicking on the Modifier Bucket.  You must restart Foundry for this setting to take effect.",
      scope: "client",
      config: true,
      type: Boolean,
      default: true,
    ...
    game.settings.register(SYSTEM_NAME, SETTING_SHOW_SHEET_NAVIGATION, {
      name: 'Show navigation on Full View',
    ...
    game.settings.register(SYSTEM_NAME, SETTING_ONLY_GMS_OPEN_ADD, {
      name: 'Only allow GMs to open the Apply Damage Calculator',
      hint: 'If checked, only GMs can open the Apply Damage Calculator.   Players who drag and drop damage will just receive a message.',
      scope: 'world',
      config: true,
      type: Boolean,
      default: true,
    ...
    game.settings.register(SYSTEM_NAME, SETTING_AUTOMATIC_ONETHIRD, {
      name: 'Automatically set Reeling and Tired',
