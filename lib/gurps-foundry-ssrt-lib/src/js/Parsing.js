...
/**
 * Parses a size, speed or range expression to extract the linear dimension and the unit of measure according to Units.js
 *
 * @function parseExpression
 * @param {string} expression
 * @returns {{unit: string, linearMeasurement: string}}
 * @public
 */
