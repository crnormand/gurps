...
export default class GURPSRange {
  ...
  setup() {
    ...
    Hooks.once('ready', async function () {
      ...
      if (!Ruler.prototype._endMeasurementOrig) Ruler.prototype._endMeasurementOrig = Ruler.prototype._endMeasurement
      else console.error('Ruler.prototype._endMeasurementOrig already set!')
      ...
      Ruler.prototype._endMeasurement = function () {
        ...
        if (Ruler.prototype._endMeasurementOrig !== Ruler.prototype._endMeasurement)
        this._endMeasurementOrig()
        else throw 'Monkey patch failure on Ruler._endMeasurement!'
