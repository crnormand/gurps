  ...
  return (function () {
  ...
  })()(
    {
          ...
          var _default = function _default(XRegExp) {
            ...
            XRegExp.matchRecursive = function (str, left, right, flags, options) {
              ...
              if (escapeChar) {
                ...
                esc = new RegExp(
                  (0, _concat['default'])(
                    (_context = (0, _concat['default'])((_context2 = '(?:'.concat(escapeChar, '[\\S\\s]|(?:(?!'))).call(
                ...
                if (leftMatch) {
                  ...
                  if (!openTokens) {
                    if (vN) {
                      ...
                      if (vN[3]) {
                        output.push(
                          row(vN[3], (0, _slice['default'])(str).call(str, delimStart, delimEnd), delimStart, delimEnd)
                        )
                      }
                    } else {
          ...
          var _default = function _default(XRegExp) {
            ...
            function buildAstral(slug, isNegated) {
              ...
              if (item.isBmpLast && item.bmp) {
                ...
                combined += (0, _concat['default'])((_context2 = ''.concat(item.astral ? '|' : '', '['))).call(
                  _context2,
                  item.bmp,
                  ']'
                )
                ...
                if (item.inverseOf) {
                  ...
                  if (!unicode.hasOwnProperty(slug)) {
                    ...
                    throw new ReferenceError(
                      (0, _concat['default'])((_context3 = ''.concat(ERR_UNKNOWN_REF + fullToken, ' -> '))).call(
                        _context3,
                        item.inverseOf
                      )
                    )
                ...
                do {
                  ...
                  if (result && result.reparse) {
                    appliedPattern =
                      ...
                      result.output +
                      (0, _slice['default'])(appliedPattern).call(appliedPattern, pos + result.matchLength)
                  }
      ...
      31: [
        function (require, module, exports) {
          ...
          function _iterableToArrayLimit(arr, i) {
            var _i =
              arr == null ? null : (typeof _Symbol !== 'undefined' && _getIteratorMethod(arr)) || arr['@@iterator']
        ...
        { '@babel/runtime-corejs3/core-js/get-iterator-method': 25, '@babel/runtime-corejs3/core-js/symbol': 27 },
      ],
      32: [
        function (require, module, exports) {
      ...
      35: [
        ...
        { '../../internals/path': 136, '../../modules/es.array.from': 163, '../../modules/es.string.iterator': 179 },
      ],
      36: [
        function (require, module, exports) {
      ...
      67: [
        ...
        { '../internals/to-absolute-index': 147, '../internals/to-indexed-object': 148, '../internals/to-length': 150 },
      ],
      68: [
        function (require, module, exports) {
          var bind = require('../internals/function-bind-context')
      ...
      69: [
        ...
        { '../internals/engine-v8-version': 93, '../internals/fails': 98, '../internals/well-known-symbol': 159 },
      ],
      70: [
        function (require, module, exports) {
          'use strict'
...
*/
      ...
      106: [
        ...
        { '../internals/descriptors': 86, '../internals/document-create-element': 87, '../internals/fails': 98 },
      ],
      107: [
        function (require, module, exports) {
          var fails = require('../internals/fails')
      ...
      145: [
        ...
        { '../internals/require-object-coercible': 139, '../internals/to-integer': 149, '../internals/to-string': 155 },
      ],
      146: [
        function (require, module, exports) {
          var requireObjectCoercible = require('../internals/require-object-coercible')
      ...
      163: [
        ...
        { '../internals/array-from': 66, '../internals/check-correctness-of-iteration': 76, '../internals/export': 97 },
      ],
      164: [
        function (require, module, exports) {
          'use strict'
        ...
        { '../internals/array-includes': 67, '../internals/array-method-is-strict': 70, '../internals/export': 97 },
      ],
      165: [
        function (require, module, exports) {
          var $ = require('../internals/export')
          ...
          $(
            { target: 'Array', proto: true, forced: FORCED },
            {
              sort: function sort(comparefn) {
                ...
                if (STABLE_SORT)
                  return comparefn === undefined ? nativeSort.call(array) : nativeSort.call(array, comparefn)
      ...
      174: [
        ...
        { '../internals/descriptors': 86, '../internals/export': 97, '../internals/object-define-property': 124 },
      ],
      175: [
        function (require, module, exports) {
