...
export class Migration {
  constructor() {
    ...
    this.migrations = [
      ...
      this.migrateActorComponentsToItems.bind(this), // migrate system.ads and system.skills to Items
    ]
  }
  ...
  async migrateActorComponentsToItems() {
    ...
    console.log('Starting migration: Convert system.ads and system.skills to Items')
    ...
    console.log(
      `Migration complete: ${migratedAdvantages} advantages and ${migratedSkills} skills migrated across ${actorsProcessed} actors`
    )
  }
}
