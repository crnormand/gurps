...
export class Migration {
  constructor() {
    ...
    this.migrations = [
      ...
      this.migrateActorComponentsToItems.bind(this), // migrate system.ads, system.skills, and system.spells to Items
    ]
  }
  ...
  async migrateActorComponentsToItems() {
    ...
    console.log('Starting migration: Convert system.ads, system.skills, and system.spells to Items')
    ...
    console.log(
      `Migration complete: ${migratedAdvantages} advantages, ${migratedSkills} skills, and ${migratedSpells} spells migrated across ${actorsProcessed} actors`
    )
  }
}
