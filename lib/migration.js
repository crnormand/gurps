...
export class Migration {
  constructor() {
    ...
    this.migrations = [
      ...
      this.migrateActorComponentsToItems.bind(this), // migrate system.ads, system.skills, system.spells, and system.eqt to Items
    ]
  }
  ...
  async migrateActorComponentsToItems() {
    ...
    console.log('Starting migration: Convert system.ads, system.skills, system.spells, and system.eqt to Items')
    ...
    console.log(
      `Migration complete: ${migratedAdvantages} advantages, ${migratedSkills} skills, ${migratedSpells} spells, and ${migratedEquipment} equipment migrated across ${actorsProcessed} actors`
    )
  }
}
