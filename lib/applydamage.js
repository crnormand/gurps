...
export default class ApplyDamageDialog extends Application {
  ...
  activateListeners(html) {
    ...
    html.find(".pdflink").click(_onClickPdf);
  ...
  updateUI(html) {
    ...
    if (this.isHalfDamage) {
      ...
      $(`<div name='result-half'>1/2D</div>`).insertBefore(insertPoint)
    ...
    if (this.applyDivisor && this.armorDivisor && this.armorDivisor !== 0) {
      ...
      if (this.dr === 0 && this.armorDivisor < 1)
        footnote = '* <span id="divisor-footnote" class="pdflink" styles="font-size: small;">B379</span>'
      ...
      html.find('#divisor-footnote').click(_onClickPdf);
    }
  }
