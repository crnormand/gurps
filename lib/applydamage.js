  ...
  updateUI(html) {
    ...
    if (this.isBluntTrauma) {
      ...
      insertPoint.append(
        ...
        $(`<input id='blunt-trauma' name='flexible-armor' class='${classText}' value='${this.effectiveBluntTrauma}' type='number' ${this.isFlexibleArmor ? '' : 'disabled'}>`)
      )
      ...
      textInput.on('change paste keyup', function () {
