...
const limbs = [
    humanoid_limbs.LEFT_ARM,
    humanoid_limbs.RIGHT_ARM,
    humanoid_limbs.LEFT_LEG,
    humanoid_limbs.RIGHT_LEG
]
const extremities = [
    humanoid_extremities.LEFT_HAND,
    humanoid_extremities.RIGHT_HAND,
    humanoid_extremities.LEFT_FOOT,
    humanoid_extremities.RIGHT_FOOT
]
const head = [
    humanoid_head.SKULL,
    humanoid_head.FACE,
    humanoid_head.LEFT_EYE,
    humanoid_head.RIGHT_EYE
]
