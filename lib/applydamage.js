...
export default class ApplyDamageDialog extends Application {
  ...
  activateListeners(html) {
    ...
    html.find('#basicDamage').on('change', ev =>
      this._updateModelFromInputText($(ev.currentTarget), "basicDamage", parseIntFrom, html))
    ...
    html.find("#user-entered-dr").on('change', ev =>
      this._updateModelFromInputText($(ev.currentTarget), "userEnteredDR", parseIntFrom, html))
    ...
    html.find('#random-location').on('click', async () => this._randomizeHitLocation(html))
    ...
    html.find("#user-entered-woundmod").on('change', ev =>
      this._updateModelFromInputText($(ev.currentTarget), "userEnteredWoundModifier", parseFloatFrom, html))
    ...
    html.find("#addmodifier").on('change', ev =>
      this._updateModelFromInputText($(ev.currentTarget), "additionalWoundModifier", parseFloatFrom, html))
    ...
    html.find('#flexible-armor').click(ev =>
      this._updateModelFromBooleanElement($(ev.currentTarget), 'isFlexibleArmor', html))
