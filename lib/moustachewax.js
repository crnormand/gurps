...
import { isArray, isEmpty, getComparison, getOperation, localizeWithFallback } from './utilities.js'
...
export default function () {
  ...
  Handlebars.registerHelper('localizeWithFallback', function (value, fallback) {
    return localizeWithFallback(value, fallback)
  })
  ...
  Handlebars.registerHelper('gurpslink', function (str, root, clrdmods = false) {
    ...
    return game.GURPS.gurpslink(str, root == true || clrdmods == true)
  })
