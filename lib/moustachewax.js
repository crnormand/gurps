...
import { isArray, isEmpty, getComparison, getOperation, i18n, i18n_f, zeroFill } from './utilities.js'
...
export default function () {
  ...
  const flatlist = function (context, level, parentkey, data, isCollapsed) {
