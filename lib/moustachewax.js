...
import { isArray, isEmpty, getComparison, getOperation, i18n } from './utilities.js'
...
`
  ...
  const templates = [
    ...
    // 'systems/gurps/templates/actor/hp-condition-block.hbs',
    // 'systems/gurps/templates/actor/resource-condition-block.hbs',
  ]
