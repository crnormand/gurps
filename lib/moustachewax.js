...
export default function () {
  ...
  Handlebars.registerHelper('hpThreshold', function (currentHP, maxHP) {
    if (!maxHP || maxHP <= 0) return 0
    if (currentHP >= maxHP) return 0
    if (currentHP > 0) return 1
    if (currentHP > -maxHP) return 2
    if (currentHP > -2 * maxHP) return 3
  ...
  Handlebars.registerHelper('hpOverlayHeight', function (currentHP, maxHP) {
    if (!maxHP || maxHP <= 0) return 0
    if (currentHP >= maxHP) return 0
  ...
  Handlebars.registerHelper('stripOtfs', function (text) {
  ...
  Handlebars.registerHelper('showTheMath', function () {
    return GURPS.modules.Damage.settings.showTheMath() ? 'checked' : ''
  })
   ...
   */
  Handlebars.registerHelper('displayNumber', function (text, options) {
  ...
  Handlebars.registerHelper('isUserCreated', function (obj) {
    return game.settings.get(GURPS.SYSTEM_NAME, Settings.SETTING_SHOW_USER_CREATED) && !!obj.save
  })

  Handlebars.registerHelper('isFoundryItem', function (obj) {
    return game.settings.get(GURPS.SYSTEM_NAME, Settings.SETTING_SHOW_FOUNDRY_CREATED) && !!obj.itemid
  })
  ...
  Handlebars.registerHelper('isFoundryGlobalItem', function (obj, doc) {
    ...
    return (
      game.settings.get(GURPS.SYSTEM_NAME, Settings.SETTING_SHOW_FOUNDRY_GLOBAL_ITEMS) && !!item?.system.globalid
    )
  })
  ...
  Handlebars.registerHelper('ignoreImportQty', function (obj) {
    return ImportSettings.displayPreserveQuantity && !!obj.ignoreImportQty
  })

  Handlebars.registerHelper('displayItemHover', function (obj, doc) {
    if (!game.settings.get(GURPS.SYSTEM_NAME, Settings.SETTING_SHOW_FOUNDRY_CREATED)) return
  ...
  Handlebars.registerHelper('automaticEncumbrance', function () {
    return game.settings.get(GURPS.SYSTEM_NAME, Settings.SETTING_AUTOMATIC_ENCUMBRANCE)
  })
  ...
  const badEffectStatuses = new Set([
    'stun',
    'mentalstun',
    'shock1',
    'shock2',
...
`
  ...
  Handlebars.registerHelper('isBoolean', function (value) {
    return typeof value === 'boolean' || value instanceof foundry.data.fields.BooleanField || value === Boolean
  })

  Handlebars.registerHelper('isString', function (value) {
    return typeof value === 'string' || value instanceof foundry.data.fields.StringField || value === String
  })

  Handlebars.registerHelper('println', function (text) {
    console.log(text)
  })
  ...
  Handlebars.registerHelper('displayAsDice', function (value, system) {
    return displayAsDice(value, system)
  })
  ...
  const templates = [
    ...
    'systems/gurps/templates/actor/modern/dice-button.hbs',
    ...
    'systems/gurps/templates/actor/modern/partials/tab-character.hbs',
    'systems/gurps/templates/actor/modern/partials/tab-combat.hbs',
    'systems/gurps/templates/actor/modern/partials/tab-equipment.hbs',
    'systems/gurps/templates/actor/modern/partials/tab-notes.hbs',
    ...
    'systems/gurps/templates/actor/modern/traits-table.hbs',
    'systems/gurps/templates/actor/modern/modifiers-table.hbs',
    'systems/gurps/templates/actor/modern/hitlocations-table.hbs',
    'systems/gurps/templates/actor/modern/encumbrance-table.hbs',
    'systems/gurps/templates/actor/modern/equipment-table.hbs',
    'systems/gurps/templates/actor/modern/header/ms-portrait.hbs',
    'systems/gurps/templates/actor/modern/header/ms-identity.hbs',
    'systems/gurps/templates/actor/modern/header/ms-attributes.hbs',
    'systems/gurps/templates/actor/modern/header/ms-resources.hbs',
    'systems/gurps/templates/actor/modern/header/ms-secondary-stats.hbs',
    ...
    'systems/gurps/templates/actor/sections/combat-status.hbs',
    'systems/gurps/templates/actor/sections/combat-info.hbs',
