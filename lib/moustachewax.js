...
import { ImportSettings } from '../module/gcs-importer/index.js'
...
import { getComparison, getOperation, isArray, isEmpty, quotedAttackName, recurselist, zeroFill } from './utilities.js'
...
export default function () {
  ...
  /// NOTE:  To use this, you must use {{{gurpslinkmd sometext}}}.   The triple {{{}}} keeps it from interpreting the HTML
  // Same as gurpslink, but converts \n to <br> for large text values (notes)
  Handlebars.registerHelper('gurpslinkmd', function (str) {
    const text = gurpslink(str)
    return foundry.appv1.sheets.JournalTextPageSheet._converter.makeHtml(text)
  })
