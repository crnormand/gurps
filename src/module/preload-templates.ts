...
export async function preloadTemplates(): Promise<Handlebars.TemplateDelegate[]> {
	const templatePaths: string[] = [
		...
		"actor/static_character/sections/notes",
		...
		"actor/static_character/sections/reactions",
		"actor/static_character/sections/resource-controls",
		"actor/static_character/sections/resource-tracker",
		"actor/static_character/sections/secondary-attributes",
		"actor/static_character/sections/pool-attributes",
		"actor/static_character/sections/skills",
		"actor/static_character/sections/speed-range-table",
		"actor/static_character/sections/spells",
