...
export class StatusEffect {
	...
	get rawStatusEffects() {
		return {
			prone: {
				icon: "systems/gurps/assets/statuses/dd-condition-prone.webp",
				id: "prone",
			...
			kneel: {
				icon: "systems/gurps/assets/statuses/condition-kneel.webp",
				id: "kneel",
			...
			crouch: {
				icon: "systems/gurps/assets/statuses/condition-crouch.webp",
				id: "crouch",
			...
			sit: {
				icon: "systems/gurps/assets/statuses/condition-sit.webp",
				id: "sit",
			...
			crawl: {
				icon: "systems/gurps/assets/statuses/condition-crawl.webp",
				id: "crawl",
			...
			grapple: {
				icon: "systems/gurps/assets/statuses/path-condition-grappled.webp",
				id: "grapple",
				label: "GURPS.STATUSGrapple",
			},
			stun: {
				icon: "systems/gurps/assets/statuses/dd-condition-stunned.webp",
				id: "stun",
				label: "EFFECT.StatusStunned",
				tint: "", // #FEAEF4 #AEFEAE
			},
			mentalstun: {
				icon: "systems/gurps/assets/statuses/dd-condition-stunned-iq.webp",
				id: "mentalstun",
				label: "GURPS.StatusStunnedMental",
				tint: "", // #FEAEF4 #AEFEAE
			},
			shock1: {
				icon: "systems/gurps/assets/statuses/condition-shock1.webp",
				id: "shock1",
				label: "EFFECT.StatusShocked",
			},
			shock2: {
				icon: "systems/gurps/assets/statuses/condition-shock2.webp",
				id: "shock2",
				label: "EFFECT.StatusShocked",
			},
			shock3: {
				icon: "systems/gurps/assets/statuses/condition-shock3.webp",
				id: "shock3",
				label: "EFFECT.StatusShocked",
			},
			shock4: {
				icon: "systems/gurps/assets/statuses/condition-shock4.webp",
				id: "shock4",
				label: "EFFECT.StatusShocked",
			},
			reeling: {
				icon: "systems/gurps/assets/statuses/cth-condition-major-wound.webp",
				id: "reeling",
			...
			exhausted: {
				icon: "systems/gurps/assets/statuses/path-condition-exhausted.webp",
				id: "exhausted",
			...
			fly: {
				icon: "systems/gurps/assets/statuses/x-flying.webp",
				id: "fly",
				label: "GURPS.STATUSFly",
			},
			fall: {
				icon: "systems/gurps/assets/statuses/condition-fall.webp",
				id: "fall",
				label: "GURPS.STATUSFall",
			},
			pinned: {
				icon: "systems/gurps/assets/statuses/path-condition-pinned.webp",
				id: "pinned",
				label: "GURPS.STATUSPin",
			},
			nauseated: {
				icon: "systems/gurps/assets/statuses/path-condition-nauseated.webp",
				id: "nauseated",
				label: "GURPS.STATUSNauseated",
			},
			coughing: {
				icon: "systems/gurps/assets/statuses/condition-cough.webp",
				id: "coughing",
				label: "GURPS.STATUSCoughing",
			},
			retching: {
				icon: "systems/gurps/assets/statuses/condition-wretch.webp",
				id: "retching",
				label: "GURPS.STATUSRetching",
			},
			drowsy: {
				icon: "systems/gurps/assets/statuses/x-drowsy.webp",
				id: "drowsy",
				label: "GURPS.STATUSDrowsy",
			},
			sleeping: {
				icon: "systems/gurps/assets/statuses/x-asleep.webp",
				id: "sleeping",
				label: "GURPS.STATUSSleep",
			},
			tipsy: {
				icon: "systems/gurps/assets/statuses/condition-drunk1.webp",
				id: "tipsy",
				label: "GURPS.STATUSTipsy",
			},
			drunk: {
				icon: "systems/gurps/assets/statuses/condition-drunk2.webp",
				id: "drunk",
				label: "GURPS.STATUSDrunk",
			},
			euphoria: {
				icon: "systems/gurps/assets/statuses/path-condition-fascinated.webp",
				id: "euphoria",
				label: "GURPS.STATUSEuphoria",
			},
			mild_pain: {
				// README No such condition in Basic -- map to Moderate Pain with HPT?
				icon: "systems/gurps/assets/statuses/condition-pain1.webp",
				id: "mild_pain",
				label: "GURPS.STATUSMildPain",
			},
			moderate_pain: {
				icon: "systems/gurps/assets/statuses/condition-pain2.webp",
				id: "moderate_pain",
				label: "GURPS.STATUSModeratePain",
			},
			moderate_pain2: {
				// README No such condition in Basic -- map to Terrible Pain with HPT?
				icon: "systems/gurps/assets/statuses/condition-pain3.webp",
				id: "moderate_pain2",
				label: "GURPS.STATUSModeratePain",
			},
			severe_pain: {
				icon: "systems/gurps/assets/statuses/condition-pain4.webp",
				id: "severe_pain",
				label: "GURPS.STATUSSeverePain",
			},
			severe_pain2: {
				icon: "systems/gurps/assets/statuses/condition-pain5.webp",
				id: "severe_pain2",
				label: "GURPS.STATUSSeverePain",
			},
			terrible_pain: {
				icon: "systems/gurps/assets/statuses/condition-pain6.webp",
				id: "terrible_pain",
				label: "GURPS.STATUSTerriblePain",
			},
			agony: {
				icon: "systems/gurps/assets/statuses/path-condition-helpless.webp",
				id: "agony",
				label: "GURPS.STATUSAgony",
			},
			bleed: {
				icon: "systems/gurps/assets/statuses/path-condition-bleeding.webp",
				id: "bleed",
				label: "GURPS.STATUSBleed",
			},
			poison: {
				icon: "systems/gurps/assets/statuses/dd-condition-poisoned.webp",
				id: "poison",
				label: "GURPS.STATUSPoison",
			},
			burn: {
				icon: "systems/gurps/assets/statuses/x-burning.webp",
				id: "burn",
				label: "GURPS.STATUSBurn",
			},
			suffocate: {
				icon: "systems/gurps/assets/statuses/condition-suffocate.webp",
				id: "suffocate",
				label: "GURPS.STATUSSuffocate",
			},
			disabled: {
				icon: "systems/gurps/assets/statuses/dd-condition-unconscious.webp",
				id: "disabled",
				label: "GURPS.STATUSDisable",
			},
			blind: {
				icon: "systems/gurps/assets/statuses/dd-condition-blinded.webp",
				id: "blind",
				label: "GURPS.STATUSBlind",
			},
			deaf: {
				icon: "systems/gurps/assets/statuses/dd-condition-deafened.webp",
				id: "deaf",
				label: "GURPS.STATUSDeaf",
			},
			silence: {
				icon: "systems/gurps/assets/statuses/x-silenced.webp",
				id: "silence",
				label: "GURPS.STATUSSilence",
			},
			stealth: {
				icon: "systems/gurps/assets/statuses/x-stealth.webp",
				id: "stealth",
				label: "GURPS.STATUSStealth",
			},
			waiting: {
				icon: "systems/gurps/assets/statuses/x-low-light-vision.webp",
				id: "waiting",
				label: "GURPS.STATUSWait",
			},
			sprint: {
				icon: "systems/gurps/assets/statuses/x-haste.webp",
				id: "sprint",
				label: "GURPS.STATUSSprint",
			},
			num1: {
				icon: "systems/gurps/assets/statuses/number-1.webp",
				id: "num1",
				label: "GURPS.STATUSCounter",
			},
			num2: {
				icon: "systems/gurps/assets/statuses/number-2.webp",
				id: "num2",
				label: "GURPS.STATUSCounter",
			},
			num3: {
				icon: "systems/gurps/assets/statuses/number-3.webp",
				id: "num3",
				label: "GURPS.STATUSCounter",
			},
			num4: {
				icon: "systems/gurps/assets/statuses/number-4.webp",
				id: "num4",
				label: "GURPS.STATUSCounter",
			},
			num5: {
				icon: "systems/gurps/assets/statuses/number-5.webp",
				id: "num5",
				label: "GURPS.STATUSCounter",
			},
			num6: {
				icon: "systems/gurps/assets/statuses/number-6.webp",
				id: "num6",
				label: "GURPS.STATUSCounter",
			},
			num7: {
				icon: "systems/gurps/assets/statuses/number-7.webp",
				id: "num7",
				label: "GURPS.STATUSCounter",
			},
			num8: {
				icon: "systems/gurps/assets/statuses/number-8.webp",
				id: "num8",
				label: "GURPS.STATUSCounter",
			},
			num9: {
				icon: "systems/gurps/assets/statuses/number-9.webp",
				id: "num9",
				label: "GURPS.STATUSCounter",
			},
			num10: {
				icon: "systems/gurps/assets/statuses/number-10.webp",
				id: "num10",
				label: "GURPS.STATUSCounter",
			},
			"bad+1": {
				icon: "systems/gurps/assets/statuses/BAD+1.webp",
				id: "bad+1",
				label: "GURPS.STATUSBad",
			},
			"bad+2": {
				icon: "systems/gurps/assets/statuses/BAD+2.webp",
				id: "bad+2",
				label: "GURPS.STATUSBad",
			},
			"bad+3": {
				icon: "systems/gurps/assets/statuses/BAD+3.webp",
				id: "bad+3",
				label: "GURPS.STATUSBad",
			},
			"bad+4": {
				icon: "systems/gurps/assets/statuses/BAD+4.webp",
				id: "bad+4",
				label: "GURPS.STATUSBad",
			},
			"bad+5": {
				icon: "systems/gurps/assets/statuses/BAD+5.webp",
				id: "bad+5",
				label: "GURPS.STATUSBad",
			},
			"bad-1": {
			...
			disarmed: {
				icon: "systems/gurps/assets/statuses/disarmed.webp",
				id: "disarmed",
