export const staticHpConditions: { [key: string]: { breakpoint: ([string]: any) => number, label: string, style: string }, } = {
	NORMAL: {
...
export const staticFpConditions: { [key: string]: { breakpoint: ([string]: any) => number, label: string, style: string }, } = {
	NORMAL: {
		breakpoint: _ => Number.MAX_SAFE_INTEGER,
		label: 'gurps.static.status.normal',
		style: 'normal',
