...
export class StaticHitLocation {
	 ...
	 */
	static ready() {
		translations[i18n('"gurps.static.hit_location.Arm, holding shield')] = "Arm, holding shield"
		translations[i18n('"gurps.static.hit_location.Arm')] = "Arm"
		translations[i18n('"gurps.static.hit_location.Brain')] = "Brain"
		translations[i18n('"gurps.static.hit_location.Chest')] = "Chest"
		translations[i18n('"gurps.static.hit_location.Chinks in Other')] = "Chinks in Other"
		translations[i18n('"gurps.static.hit_location.Chinks in Torso')] = "Chinks in Torso"
		translations[i18n('"gurps.static.hit_location.Extremity')] = "Extremity"
		translations[i18n('"gurps.static.hit_location.Eye')] = "Eye"
		translations[i18n('"gurps.static.hit_location.Eyes')] = "Eyes"
		translations[i18n('"gurps.static.hit_location.Face, from behind')] = "Face, from behind"
		translations[i18n('"gurps.static.hit_location.Face')] = "Face"
		translations[i18n('"gurps.static.hit_location.Fin')] = "Fin"
		translations[i18n('"gurps.static.hit_location.Foot')] = "Foot"
		translations[i18n('"gurps.static.hit_location.Foreleg')] = "Foreleg"
		translations[i18n('"gurps.static.hit_location.Groin')] = "Groin"
		translations[i18n('"gurps.static.hit_location.Hand')] = "Hand"
		translations[i18n('"gurps.static.hit_location.Hind Leg')] = "Hind Leg"
		translations[i18n('"gurps.static.hit_location.Jaw')] = "Jaw"
		translations[i18n('"gurps.static.hit_location.Left Arm, holding shield')] = "Left Arm, holding shield"
		translations[i18n('"gurps.static.hit_location.Left Arm')] = "Left Arm"
		translations[i18n('"gurps.static.hit_location.Left Leg')] = "Left Leg"
		translations[i18n('"gurps.static.hit_location.Leg')] = "Leg"
		translations[i18n('"gurps.static.hit_location.Limb Vein/Artery')] = "Limb Vein/Artery"
		translations[i18n('"gurps.static.hit_location.Mid Leg')] = "Mid Leg"
		translations[i18n('"gurps.static.hit_location.Neck Vein/Artery')] = "Neck Vein/Artery"
		translations[i18n('"gurps.static.hit_location.Neck')] = "Neck"
		translations[i18n('"gurps.static.hit_location.Nose')] = "Nose"
		translations[i18n('"gurps.static.hit_location.Right Arm, holding shield')] = "Right Arm, holding shield"
		translations[i18n('"gurps.static.hit_location.Right Arm')] = "Right Arm"
		translations[i18n('"gurps.static.hit_location.Right Leg')] = "Right Leg"
		translations[i18n('"gurps.static.hit_location.Skull, from behind')] = "Skull, from behind"
		translations[i18n('"gurps.static.hit_location.Skull')] = "Skull"
		translations[i18n('"gurps.static.hit_location.Tail')] = "Tail"
		translations[i18n('"gurps.static.hit_location.Torso')] = "Torso"
		translations[i18n('"gurps.static.hit_location.Vitals, Heart')] = "Vitals, Heart"
		translations[i18n('"gurps.static.hit_location.Vitals')] = "Vitals"
		translations[i18n('"gurps.static.hit_location.Where')] = "Where"
		translations[i18n('"gurps.static.hit_location.Wing')] = "Wing"
	}
