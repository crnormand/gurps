...
export class GurpsActorSheet extends ActorSheet {
	...
	activateListeners(html) {
		...
		html.find('button[data-operation="resource-inc"]').click(async ev => {
			...
			let value = (Number(tracker.value) || 0) + (ev.shiftKey ? 5 : 1);
		...
		let d = new Dialog(
			{
				...
				content: await renderTemplate("systems/gurps/templates/actor/update-tracker.html", {
					templates: templates,
				}),
				buttons: buttons,
				default: "edit",
		...
		switch (elementid) {
			...
			case "#reactions":
				return [
					this.addItemMenu(
						i18n("GURPS.reaction"),
						new Reaction("+0", i18n("GURPS.fromEllipses")),
						"data.reactions"
					),
					...menu,
				];
			...
			case "#melee":
				return [
					this.addItemMenu(
						i18n("GURPS.meleeAttack"),
						new Ranged(`${i18n("GURPS.meleeAttack")}...`),
						"data.melee"
					),
					...menu,
				];
			...
			case "#ranged":
				return [
					this.addItemMenu(
						i18n("GURPS.rangedAttack"),
						new Ranged(`${i18n("GURPS.rangedAttack")}...`),
						"data.ranged"
					),
					...menu,
				];
			...
			case "#advantages":
				return [
					this.addItemMenu(
						i18n("GURPS.adDisadQuirkPerk"),
						new Advantage(`${i18n("GURPS.adDisad")}...`),
						"data.ads"
					),
					...menu,
				];
