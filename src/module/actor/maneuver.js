...
export const PROPERTY_MOVEOVERRIDE_MANEUVER = "moveoverride.maneuver";
export const PROPERTY_MOVEOVERRIDE_POSTURE = "moveoverride.posture";
...
Object.defineProperty(Actor.prototype, "temporaryEffects", {
	get: function() {
		...
		if (results && results.length > 1) {
			...
			const maneuvers = results.filter(
				(/** @type {ActiveEffect} */ e) => e.getFlag("core", "statusId") === MANEUVER
			);
			const notManeuvers = results.filter(
				(/** @type {ActiveEffect} */ e) => e.getFlag("core", "statusId") !== MANEUVER
			);
 ...
 */
class Maneuver {
	static filepath = "systems/gurps/assets/maneuvers/";
