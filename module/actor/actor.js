...
export class GurpsActor extends Actor {
	...
	_getCurrentMove(move, threshold) {
		...
		if (threshold == 1.0)
			this.system.conditions.move = maneuver.move < posture.move ? maneuver.text : posture.text
		return updateMove
	...
	async accumulateDamageRoll(action) {
		...
		if (!this.system.conditions.damageAccumulators)
			this.system.conditions.damageAccumulators = []
