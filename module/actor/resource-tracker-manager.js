...
export class ResourceTrackerManager extends FormApplication {
  ...
  static getDefaultTemplates() {
    return {
      '0000': {
        tracker: {
          name: game.i18n.localize('GURPS.fdg.ControlPoints'),
          alias: game.i18n.localize('GURPS.fdg.CPAbbrev'),
          pdf: 'FDG4',
          max: 0,
          min: 0,
          value: 0,
          ...
          thresholds: [
            {
              ...
              operator: '×',
              value: 0.1,
              condition: game.i18n.localize('GURPS.fdg.Unrestrained'),
              color: '#90ee90',
            },
            {
              comparison: '≥',
              operator: '×',
              value: 0.5,
              condition: game.i18n.localize('GURPS.fdg.Grabbed'),
              color: '#eeee30',
            },
            {
              comparison: '≥',
              operator: '×',
              value: 1,
              condition: game.i18n.localize('GURPS.fdg.Grappled'),
              color: '#eeaa30',
            },
            {
              comparison: '≥',
              operator: '×',
              value: 1.5,
              condition: game.i18n.localize('GURPS.fdg.Restrained'),
              color: '#ee5000',
            },
            {
              comparison: '≥',
              operator: '×',
              value: 2,
              condition: game.i18n.localize('GURPS.fdg.Controlled'),
              color: '#ee0000',
            },
            {
              comparison: '≥',
              operator: '×',
              value: 2,
              condition: game.i18n.localize('GURPS.fdg.Pinned'),
              color: '#900000',
            },
          ],
        },
