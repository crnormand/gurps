...
export const Maneuvers = {
  do_nothing: {
    move: MOVE_NONE,
    defense: DEFENSE_ANY,
    icon: 'systems/gurps/icons/statuses/_do_nothing.png',
    label: 'GURPS.maneuverDoNothing',
  },
  move: {
    move: MOVE_FULL,
    defense: DEFENSE_ANY,
    icon: 'systems/gurps/icons/statuses/_move.png',
    label: 'GURPS.maneuverMove',
  },
  aim: {
    move: MOVE_STEP,
    defense: DEFENSE_ANY,
    icon: 'systems/gurps/icons/statuses/_aim.png',
    label: 'GURPS.maneuverAim',
  },
  change_posture: {
    move: MOVE_NONE,
    defense: DEFENSE_ANY,
    icon: 'systems/gurps/icons/statuses/_change_posture.png',
    label: 'GURPS.maneuverChangePosture',
  },
  evaluate: {
    move: MOVE_STEP,
    defense: DEFENSE_ANY,
    icon: 'systems/gurps/icons/statuses/_evaluate.png',
    label: 'GURPS.maneuverEvaluate',
  },
  attack: {
    move: MOVE_STEP,
    defense: DEFENSE_ANY,
    icon: 'systems/gurps/icons/statuses/_attack.png',
    label: 'GURPS.maneuverAttack',
  },
  feint: {
    move: MOVE_STEP,
    defense: DEFENSE_ANY,
    icon: 'systems/gurps/icons/statuses/attack.png',
    label: 'GURPS.maneuverFeint',
  },
  allout_attack: {
    move: MOVE_HALF,
    defense: DEFENSE_NONE,
    icon: 'systems/gurps/icons/statuses/_allout_attack.png',
  ...
  move_and_attack: {
    ...
    icon: 'systems/gurps/icons/statuses/_move_attack.png',
    label: 'GURPS.maneuverMoveAttack',
  },
  allout_defense: {
    move: MOVE_HALF,
    defense: DEFENSE_ANY,
    icon: 'systems/gurps/icons/statuses/_allout_defense.png',
  ...
  ready: {
    move: MOVE_STEP,
    defense: DEFENSE_ANY,
    icon: 'systems/gurps/icons/statuses/_ready.png',
    label: 'GURPS.maneuverReady',
  },
  concentrate: {
    move: MOVE_STEP,
    defense: DEFENSE_ANY,
    icon: 'systems/gurps/icons/statuses/_concentrate.png',
    label: 'GURPS.maneuverConcentrate',
  },
  wait: {
    move: MOVE_NONE,
    defense: DEFENSE_ANY,
    icon: 'systems/gurps/icons/statuses/_wait.png',
