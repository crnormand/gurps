...
class Length<Parent extends DataModel.Any | null = DataModel.Any | null> extends DataModel<LengthSchema, Parent> {
  ...
  static from(value: unknown, unit: LengthUnit, forced: boolean = false): Length | null {
    function returnNull() {
    ...
    if (typeof value === 'number') {
      ...
      return Length.fromString(`${value}`, Length.Unit.Inch, forced)
    } else if (typeof value === 'string') {
      return Length.fromString(value, unit, forced)
    }
