...
namespace GurpsRuler {
  export interface WaypointContext extends Ruler.WaypointContext {
    modifier?: { total: number }
  }
}
...
class GurpsRuler extends foundry.canvas.interaction.Ruler {
  ...
  protected override _getWaypointLabelContext(
    ...
    const context: GurpsRuler.WaypointContext | void = super._getWaypointLabelContext(waypoint, state)
